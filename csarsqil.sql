...
create table if not exists track_info (track_id serial primary key, track_name varchar(60), time_of_track integer, album_in_id integer references albums(album_id));